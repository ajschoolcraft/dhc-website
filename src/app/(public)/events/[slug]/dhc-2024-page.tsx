...
import { speakers, schedule } from "./dhc-2024-data";
import type { Speaker } from "./dhc-2024-data";
...
export default function DHC2024Page() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <div className="mb-4 flex items-center gap-3">
        <Badge variant="info">October 8–9, 2024</Badge>
        <Badge>Seattle, WA</Badge>
      </div>
      <h1 className="text-3xl font-bold text-text sm:text-4xl">
        Digital Health Counsel 2024 AI Summit
      </h1>
      <p className="mt-4 max-w-3xl text-text-light leading-relaxed">
        The second annual Digital Health Counsel AI Summit expanded to include
        product counsel, privacy, AI governance, and health transparency tracks.
        In collaboration with Ogden Murphy Wallace, Milliman, and Fenwick, DHC
        2024 brought together general counsel, product counsel, regulators,
        academics, technologists, and health system leaders for two days of
        focused programming on the legal and governance infrastructure required
        for healthcare AI.
      </p>
